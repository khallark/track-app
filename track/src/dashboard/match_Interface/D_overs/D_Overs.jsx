                    ...
                    {overs_1.map((over, index) => (
                        <div key={nanoid()} className={`py-2 flex flex-col`}>
                            <div className={`flex 700:gap-x-1`}>
                                <h1 className={`font-robotoSans pr-3 text-[.9rem] 700:text-[1rem] ${theme ? 'text-[#3b3b3b]' : 'text-[#797979] text-nowrap'}`}>[ {index + 1} ] &nbsp; <span className='font-robotoSans font-[400] underline underline-offset-4 text-nowrap'>{over[0]}</span></h1>
